            ...
            <div class="row justify-content-center">
                <div class="col-md-10 align-self-center">
                    <div class="row g-3 justify-content-center">
                        <div class="col-md-8">
                            <div class="">
                                <form class="px-1 py-3 bg-white rounded">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-10">
                                            <div class="input-group mb-3 rounded">
                                                <span class="input-group-text me-1 bg-primary" id="basic-addon1"><i class="fa fa-building text-white"></i></span>
                                                <input type="text" class="form-control" placeholder="Village" aria-label="Username" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        <div class="col-md-10">
                                            <div class="input-group mb-3 rounded">
                                                <span class="input-group-text me-1 bg-primary" id="basic-addon1"><i class="fa fa-phone-volume text-white"></i></span>
                                                <input type="tel" class="form-control" placeholder="Contact No" aria-label="Username" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        <div class="col-md-10">
                                            <div class="input-group mb-3 rounded ">
                                                <span class="input-group-text me-1 bg-primary" id="basic-addon1"><i class="fa fa-edit text-white"></i></span>
                                                <textarea class="form-control" placeholder="Mention your concern!!!" aria-label="Username" aria-describedby="basic-addon1" rows="8"></textarea>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="row mb-3 py-3 py-md-5">
                                ...
                                <div class="col-md-10 mb-3">
                                    <div class="">
                                        <div class="text-center">
                                            <a href="mailto:dendulurumla64@gmail.com" class="text-decoration-none text-dark ">dendulurumla64@gmail.com</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2 mb-3 align-self-center">
                                ...
                                <div class="col-md-10 mb-3">
                                    <div class="">
                                        <div class="text-center">
                                            <a href="https://m.facebook.com/kotaru9999" class="text-decoration-none"><i class="fa-brands fa-facebook-f ms-2 border rounded p-3"></i></a>
                                            <a href="https://twitter.com/AbbayaChowdary"><i class="fa-brands fa-twitter ms-2 border rounded p-3"></i></a>
                                            <a href="https://youtube.com/channel/UC6odSmHbX9fgBVBgWdZmJLQ"><i class="fa-brands fa-youtube ms-2 border rounded p-3"></i></a>
