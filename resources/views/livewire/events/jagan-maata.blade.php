                    ...
                    <div class="bg-white shadow py-3 rounded" style="height:200px;" style="height:390px;">
                        <a href="#event1" class="text-decoration-none">
                            <div class="text-center">
                                <h5 class="text-center text-primary py-5">Good Morning <br />Denduluru</h5>
                            </div>
                        </a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                        <img src="{{asset('assets/images/goodmorning/good1.png')}}" class="img-fluid">
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="row">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-6">
                        <img src="{{asset('assets/images/secretariat-visits/rev1.png')}}" class="img-fluid">
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row g-2">
                    <h2 class="text-success text-center pt-2 pb-2">Gallery</h2>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                        <img src="{{asset('assets/images/review-meetings/meet1.jpg')}}" class="img-fluid">
                    </div>
