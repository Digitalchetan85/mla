<div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        recognized guardian in the absence of mother, who is below poverty line household, irrespective
                        of caste, creed, religion and region to enable her to educate her child/children from Class I to
                        XII (Intermediate Education) in all recognized Government, Private Aided and Private Unaided
                        schools/ Jr. Colleges including Residential Schools/Colleges in the State from the Academic year
                        2020-2021.
                    </p>
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        association with Pradhan Mantri Kisan Samman Nidhi with the state government contributing ₹7500
                        and the center ₹6000.
                    </p>
            ...
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        of students because the government wants to help the students to study all their desired courses
                        without doing any errands or part-time jobs. The scholarship will help the students to carry on
                        education and to become successful people in the future
                    </p>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        education but they are unable to pay their fees because of the financial burden of their family.
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <div class="">
                        ...
                        <p class="">
                            ...
                            and so on. Farmers will be compensated for crops lost due to these calamities by the
                            government. Under this policy, farmers are not required to pay any premiums. They will be
                            protected from financial difficulty as a result of this. The plan’s implementation will also
                            provide the system with greater transparency.
                        </p>
                        <div class="table-responsive py-3 py-md-3">
                            <table class="table-bordered text-center">
                                <thead>
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        crops due to natural calamities. There will be around 22 notified crops. This crop Insurance
                        will be free of cost. Previously the farmers were required to pay a high premium amount in order
                        to take benefits of the<strong> YSR Crop Insurance Scheme</strong>.
                    </p>
            ...
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        SHG bank loan amount outstanding as on 11/04/2019 under YSR Sunna Vadi.
                    </p>
                    <h5>Benefits to the citizens</h5>
                    <hr />
                    <ul>
                        <li>Zero interest for poor self-help group women</li>
                        <li>This scheme will help in enhancing livelihood opportunities and encourage in the development
                            of rural areas.</li>
                        <li>The scheme improves the financial condition of the SHG women along with the social security.
                        </li>
                        <li>All SHG women both rural and urban with bank loan accounts outstanding amount upto Rs.5.00
                            lakhs will get the YSR Sunna Vaddi Pathakam.</li>
                        <li>SHG loan accounts declared NPA as on 31/03/2019 as per SERP and MEPMA data base will not get
                            the YSR Sunna Vaddi Pathakam.</li>
                    </ul>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        developmental programmes to achieve this objective.
                    </p>
                    <p>As part of the Navarathnalu , enhancement of pension amount and reduction in the age criteria for
                        old age pension is a major welfare measure to ameliorate the hardships of the poor and
                        vulnerable sections of the society particularly the old and infirm, widows, and persons with
                        disability to secure a dignified life.</p>
                    <p>In pursuit of this overarching goal, inspite of the challenging financial conditions, orders were
                        issued vide G.O.Ms.No.103 Dated: 30.05.2019 enhancing the Social Security Pensions amount for
                        old Age Persons, widow, Toddy Tappers, weavers, Single women, Fishermen, ART (PLHIV) Persons ,
                        Traditional Cobblers to Rs.2500/- per month, Disabled persons,Transgender and Dappu Artists to
                        Rs.3,000/- per month, and also for people affected with Chronic Kidney Disease who are
                        undergoing Dialysis both Government and network hospitals to Rs.10,000/- per month. The enhanced
                        scale of pension came into effect from June, 2019 payable from 1st July, 2019 onwards.</p>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
                                <tr>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <hr />
                    <ul>
                        <li>Assistance of Rs 75,000 over a period of four years will be provided to the women
                            beneficiary in four equal installments of Rs. 18750 each Per Year.</li>
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        Perni Venkataramaiah (Nani) said while explaining about the cabinet meeting decisions to the
                        media that YSR Aasara main objective is at empowering women and improving their financial
                        stability. Under this scheme, the government will provide financial help to DWCRA women.
                    </p>
                    <h5 class="text-success">Benefits And Features Of YSR Asara Scheme</h5>
                    <ul>
                        <li>By the implementation of this scheme financial help will be provided to needy women who are
                            living in Andhra Pradesh.</li>
                        <li>YSR Asara scheme will increase the women empowerment rate
                        <li> The Government of Andhra Pradesh is going to give SHG loan to women who belong to the
                            minority community.</li>
                        <li> Now the females of Andhra Pradesh will not have to take a loan on a higher rate of
                            interest.</li>
                        <li> Through this scheme, the amount will be paid directly into the bank account of the
                            beneficiary.</li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <hr />
                    <p class="">
                        The main object of the scheme is to provide relief to the families of unorganized workers in
                        case of death or disability of the unorganised worker leaving the families in great distress.
                    </p>
                    <h5> Benefits to the citizens</h5>
                    <hr />
                    <p>The registered unorganised workers will be enrolled as members under State Accident Death and
                        Disability Scheme and under Aam Admi Bima Yojana (AABY) and will also be covered under the
                        Pradhan Mantri Suraksha Bima Yojana (PMSBY). They shall receive the following benefits: </p>
                    <ul>
                        <li>Rs.2 lakh for 18-50 years and Rs.30,000/- for 51-60 years towards natural death, Rs.5 lakh
                            for accident death and total disability and Rs.2.50 lakh for partial disability for 18-70
                            years.</li>
                        <li>Scholarship Rs.1,200/- for children (up to two children) studying 9th, 10th, Inter and ITI.
                        </li>
                        <li>Total online claim settlement process. Rs.5,000/- paid within (2) days towards funeral
                            expenses and total balance amount paid on 11th day or 13th day death ceremony.</li>
                    </ul>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <ul>
                        ...
                        <li>AP Government will provide a financial assistance of Rs.75,000/-at the rate of Rs.15,000/-
                            per annum for the next 5 years</li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        The scheme aims to provide financial assistance to the handloom weavers so that they can improve
                        their handloom works.
                    </p>
                    <h5>Benefits to the citizens</h5>
                    <hr />
                    <p>Under the scheme, Rs 24,000 will be credited directly into the bank accounts of the weavers
                        having own looms every year. Every beneficiary will receive a total aid of Rs 1.2 lakh in the
                        next five years.</p>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <p>It is a state governement funded welfare scheme only for tailors, washermen and Barbers of the
                        state, who had lost their livelihood due to COVID-19 pandemic. The fund provided to each
                        beneficiary will be transferred directly to their bank accounts. The beneficiaries will be
                        identified and shortlisted through surveys.</p>
                    <h5>Benefits to the citizens</h5>
                    <hr />
                    <p class="">
                        Under this scheme, beneficiaries will be provided a one time amount of Rs.10,000. This fund can
                        be utilised by the beneficiaries for purchasing tools, equipment and other essentials to grow
                        their source of income and work establishment. This will help them to fulfil their investment
                        needs.
                    </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <h5>Benefits to the citizens</h5>
                    <hr />
                    <p>All the junior advocates and lawyers will get Rs. 5,000 per month as stipend during the first
                        three years of practice.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <hr />
                    <p class="">
                        AP government is providing Rs 10,000 financial assistance to auto, taxi and maxi driver/owners
                        yearly under YSR Vahana Mitra scheme. For maintenance expenses, and for obtaining insurance and
                        fitness certificates among other documents.
                    </p>
                    <h5>Benefits to the citizens</h5>
                    <hr />
                    <p>Through the Vahana Mitra Yojana, the goal of the state government is to increase the income and
                        reduce the expenses of taxi repair by providing financial assistance to the financially weak
                        taxi drivers. The fund amount of Rs 10,000 will be provided to the entire auto, cab drivers
                        registered under the Mitra Scheme through a bank account.</p>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
                                <tr>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <hr />
                    <p class="">
                        YSR Aarogya Aasara scheme provides post-therapeutic sustenance allowance to the poor patients
                        during their recovery period. After the poor patients get their treatment with the help of YSR
                        Arogya Sri, the state government offers them a maximum of Rs 225 per day or a maximum of Rs
                        5,000 per month for the prescribed relaxation time under the Aaogya Aasara scheme. This
                        wage-loss allowance is applicable to 836 kinds of surgeries in 26 specialised areas.
                    </p>
                    <h5>Benefits to the citizens</h5>
                    <hr />
                    <p>Under this scheme, the poor patients will receive a financial assistance from the government,
                        after they are discharged from the hospitals. They money will help the patient to meet the
                        economic needs of the family, and post-treatment medications. </p>
                    <ul>
                        <li>In the implementation of this scheme, the patient will be able to get a maximum of Rs 225
                            per day or a maximum of Rs 5,000 per month for the prescribed relaxation time.</li>
                        <li>The amount of assistance will be disbursed directly to the bank account of the beneficiary.
                        </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <hr />
                    <p class="">
                        YSR Navodayam objective is to fullfill the needs of micro, small and medium enterprises (MSMEs)
                        in the Andhra Pradesh State by providing financial relief by restructuring their bank loans.
                    </p>
                    <h5>Benefits to the citizens</h5>
                    <hr />
                    <ul>
                        <li>One Time Restructuring (OTR) of MSME loans scheme under an umbrella program Dr. Y.S.R
                            Navodayam which creates a new ecosystem for MSMEs ensuring that all the eligible MSME units
                            are covered for one time Restructuring of accounts upto 31-03-2020.</li>
                        <li>Reimbursing 50% (not exceeding Rs.2,00,000/- (Two Lakhs) per account) of the auditor’s fee
                            for preparation of Techno Economic Viability (TEV) report, wherever such report is
                            applicable, for the cases restructured by the banks under OTR. </li>
                    </ul>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <p>The primary objective of this scheme is to provide monetary help for healthcare services to
                        low-income families.</p>
                    <p>The features of the Dr YSR Aarogyasri Health Care Trust managed scheme are as follows:</p>
                    <ul>
                        <li>Cashless healthcare - This insurance scheme provides around Rs.5 lakhs as financial coverage
                            for the beneficiary and his registered family.</li>
                        <li>In-patient healthcare - Dr YSR Aarogyasri Health Insurance Scheme covers in-patient care for
                            a list of diseases and therapies mentioned under the programme. Additionally, it also covers
                            hospitalization expenses</li>
                        <li>Floater health insurance cover - Under the Dr YSR Aarogyasri Health Insurance Scheme, the
                            entire family is covered. There is no need for separate cover for any member.</li>
                        <li>Outpatient healthcare - In addition to in-patient care, the programme also provides
                            outpatient care at government hospitals and health camps.</li>
                        <li>Follow-up treatments - One of the best features of Dr YSR Aarogyasri Health Care Trust’s
                            insurance scheme is that it also covers follow-up therapies and procedures.</li>
                        <li>Pre-existing disease coverage - Moreover, if the beneficiary already suffered from a disease
                            before registering for this scheme, he can still seek coverage for its treatment. This
                            feature is a standout among other commercially available health insurance schemes.</li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <h5>Benefits to the citizens</h5>
                    <hr />
                    <p>Interest-free term loan of Rs 10,000 per year would be extended to the hawkers, street vendors,
                        and artisans engaged in traditional handicrafts through banks.</p>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
                                <tr>
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        effect from October, 2008 (100% State share). It was further extended to Special Training
                        Centres (NCLP) from 2010. Model schools are also being covered from the year 2013-14. The
                        Hon’ble Chief Minister of Andhra Pradesh has been giving top-most priority to the School
                        Education Department since 2019. As a part of it, many reforms were made in the erstwhile PM
                        Poshan (MDM) Scheme through changes in different aspects of the programme like upgraded menu
                        with variety and tastes enhanced honorarium of the cooks, Real Time Monitoring through Mobile
                        App & Dashboard, Four -Tier Monitoring System and reviews of the programme at different level.
                        With these reforms and enhanced budget, the programme has been renamed as “Jagananna Gorumudda –
                        PM Poshan”.
                    </p>
            ...
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        implemented in 55,607 Anganwadi Centres. To achieve reduction in malnutrition and anemia in
                        children (below 6 years) and pregnant, lactating women, Government is implementing YSR Sampoorna
                        Poshana and YSR Sampoorna Poshana Plus (+).
                    </p>
                    <p>YSR Sampoorna Poshana Plus+ Scheme is being implemented in 77 Scheduled and Tribal Sub Plan
                        Mandals, the YSR Sampoorna Poshana Scheme is implemented in the remaining mandals of the State.
                        It is estimated 3.8 lakh beneficiaries in 77 tribal mandals and 26.36 lakh beneficiaries in the
                        remaining mandals in the State will be covered for providing ICDS services through 55,607
                        Anganwadi Centers, in consultation with National Institute of Nutrition (NIN).</p>
                    <p>Current nutrition programs designed to ensure uniformity and greater coverage of beneficiaries
                        with recommended nutritional standards, while providing iron, protein, energy rich nutrition to
                        pregnant women, lactating mothers. Keeping in view of Under Weight or Malnourished children and
                        high prevalence of anemia in pregnant and lactating mothers nutrition programs have been
                        designed .</p>
                    <p>By providing Supplementary feeding, this nutrition program attempts to bridge the caloric gap
            ...
            <div class="row">
                <div class="col-md-8 align-self-center">
                    ...
                    <p>The government provides three pairs of uniforms, set of notebooks, text books, a pair of shoes
                        and two pairs of socks, a belt, school bag to all students from class I to X in all government
                        schools.</p>
                    <h5>Benefits to the citizens</h5>
                    <hr />
                    <p class="">
                        The scheme would benefit nearly 39.70 lakh students across the state and has been made all
                        arrangements under auspices of Samagra Shishu Abhiyan to provide 7 items to students on the
                        first day of reopening of public schools. The government will also provide bus transportation to
                        the students for free of charge. It is also noted that the students can join either of English
                        medium or Telugu medium. However, it has made Telugu mandatory in every classroom where English
                        medium is taught.
                    </p>
            ...
            <div class="row">
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <p class="">
                        ...
                        monetary benefits to support their living due to economical backwardness. The scheme was not a
                        part of the manifesto. However, the YS Government aimed to launch the scheme on the occasion of
                        73rd Republic Day. The main aim of the scheme is to financially support the lives of middle-aged
                        upper-caste Hindu EBC women and empower them.
                    </p>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <ol type="1" class="">
                        <li>Under YSR Jala Kala programme of NAVARATNALU, Government have decided to drill free
                            borewells to needy and eligible farmers in all thirteen (13) districts of the State by for
                            the purpose of irrigating every acre of arable land.</li>
                        <li>The borewell sites shall be identified scientifically by conducting ground water surveys
                            before taking up the drilling.</li>
                        <li>Any farmer without an existing borewell and with a contiguous land of 2.5 acres is eligible.
                            If the farmer is not having contiguous land of 2.5 acres, a group may be formed and can
                            apply for free borewell.</li>
                        <li>Any farmer without an existing borewell and with a contiguous land of 2.5 acres is eligible.
                            If the farmer is not having contiguous land of 2.5 acres, a group may be formed and can
                            apply for free borewell.</li>
                        <li>Priority shall be given to small & marginal farmers and SC / ST / Women farmers.</li>
                        <li>Farmers can apply for free borewell through online or offline through village secretariat
                            and VRO will verify and forward the application to concerned APD / MPDO.</li>
                        <li>Assigned drilling contractor will conduct ground water survey by engaging qualified
                            geologist and submit the feasibility report to concerned APD / MPDO for generating estimate.
                        </li>
                        <li>PD will take administrative approval from District Collector / JC, Aasara and entrust the
                            work to drilling contractor.</li>
                        <li>Information regarding the sanction of borewells will be communicated to the applicants at
                            each stage through SMS.</li>
                        <li>The digital photograph with geo-tag will be taken by the concerned authorities along with
                            beneficiary in the presence of drilling contractor after completion of borewell drilling.
                        </li>
                        <li>The depth of borewell drilled and depth of casing will be measured with advanced IoT enabled
                            equipments minimizing human intervention.</li>
                        <li>Payment to drilling contractors will be made as per the predefined success rates of
                            districts.</li>
                        <li>If a borewell fails, a second borewell will be drilled if feasible.</li>
                        <li>Construction of recharge pit / water harvesting structure will be taken up at successful
                            borewell site.</li>
                        <li>Social Audit will be conducted for all the borewells drilled under this program.</li>
                        <li>A programme management unit (PMU) will be set up at headquarters for effective monitoring of
                            the implementation of the programme.</li>
                        <li>16. Roles & responsibilities of various functionaries for implementation of the programme
                            are defined and are included in the GO.</li>
                        <li>17. District Collectors will guide and direct all the stakeholders for effective
                            implementation of the programme.</li>
                    </ol>
                    <div class="table-responsive py-3 py-md-3">
                        <table class="table-bordered text-center">
                            <thead>
    ...
    <div id="scheme27" class="py-3 py-md-5">
        <div class="container">
            <div class="row">
                <div class="col-md-4 align-self-center">
                    <div class="text-center">
